...
<div id="page-pagination-mode" class="am-text-xs dataTables_paginate">
	...
	<ul class="pagination">
		<li class="prev">
			<a href="group/specificGroup?groupId=${groupId}&page=${page.firstPage}">
		...
		<li class="prev">
			<c:if test="${page.pageNum != page.firstPage}">
				<a href="group/specificGroup?groupId=${groupId}&page=${page.prePage}">
		...
		<li class="pre">
			...
			<a href="group/specificGroup?groupId=${groupId}&page=${page.nextPage}">
				下页
		...
		<li class="pre">
			<a href="group/specificGroup?groupId=${groupId}&page=${page.lastPage}">
				末页
