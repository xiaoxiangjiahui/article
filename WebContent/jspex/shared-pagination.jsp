...
<div id="page-pagination-mode" class="am-text-xs dataTables_paginate">
	...
	<ul class="pagination">
		<li class="prev">
			<a href="personal/shared?page=${page.firstPage}">
		...
		<li class="prev">
			<c:if test="${page.pageNum != page.firstPage}">
				<a href="personal/shared?page=${page.prePage}">
		...
		<li class="pre">
			...
			<a href="personal/shared?page=${page.nextPage}">
				下页
		...
		<li class="pre">
			<a href="personal/shared?page=${page.lastPage}">
				末页
