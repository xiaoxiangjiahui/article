                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="Search for Title..." style="height:55px;border: none;" id="titleSearch">
                                                <div class="input-group-btn btn-theme-panel">
                                                	  <a href="javascript:;" class="btn dropdown-toggle" data-toggle="dropdown">
														   <i class="fa fa-bars"></i>
													  </a>
	                                                  <div class="dropdown-menu theme-panel pull-right dropdown-custom hold-on-click">
														<div class="row">
															<div class="col-md-12 col-sm-12 col-xs-12" id="searchForm">
																<ul class="theme-settings">
																	<li style="margin-bottom: 30px;"> <label class="col-md-3 control-label" style="text-align: right;">作者</label>
																		<div class="col-md-9">
																			<input class="form-control input-inline " id="auth">
																		</div>	
																	</li>
																	<li style="margin-bottom: 30px;"> <label class="col-md-3 control-label" style="text-align: right;">摘要关键词</label> 
																		<div class="col-md-9">
																			<input class="  form-control input-inline "id="abst">
																		</div>	
																	</li>
																	<li style="margin-bottom: 30px;"><label class="col-md-3 control-label" style="text-align: right;">分类</label> 
																		<div class="col-md-9">
																			<select class="  form-control  input-inline " id="categorySearch">
																				<option value="0">请选择分类</option>
																			</select>
																		</div>
																	</li>
																	<li style="margin-bottom: 30px;">
																		<label class="col-md-3 control-label" style="text-align: right;"></label> 
																		<div class="col-md-9">
																			<button class="btn btn-sm btn-success" style="height:34px;" id="attachSearch">搜索</button>
																		</div> 
																	</li>
																</ul>
															</div>
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn blue bold" type="button" id="searchBtn">搜索</button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8 col-sm-8" style="padding-right: 0;">
                                        <div class="portlet light " style="height: 100%;min-height:750px;">
                                            ...
                                            <div class="portlet-body" id="article-body">
                                                 ...
                                                 <jsp:include page="../jspex/pagination.jsp" flush="true"/>
                                            </div>
...
<script>
	...
	function download() {
	    ...
	    $.ajax({
	        ...
	        async: false,
	        success: function (data) {
	        	window.open("/filedownload/"+data.path);
	...
	$("#shareto").on("click",function(){
		var c = $("input[name='check']").is(":checked");
		console.log(c);
		if(!c){
			return;
		}else{
	...
	$("#attachSearch").on("click",function(){
		var keyw = $("#titleSearch").val();
		var auth = $("#auth").val();
		var abst = $("#abst").val();
		...
		$.ajax({
			...
			type:"POST",
			data:{keyw:keyw,auth:auth,abst:abst,cid:Number(cid)},
			dataType: "html",  
            cache:false,  
			success: function(data){
				detailVM.$data.docObj = [];
