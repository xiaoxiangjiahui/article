...
<div id="page-pagination-mode" class="am-text-xs dataTables_paginate">
	...
	<ul class="pagination">
		<li class="prev">
			<a href="javascript:searchpage(${page.firstPage});">
		...
		<li class="prev">
			<c:if test="${page.pageNum != page.firstPage}">
				<a href="javascript:searchpage(${page.prePage});">
		...
		<li class="pre">
			...
			<a href="javascript:searchpage(${page.nextPage});">
				下页
		...
		<li class="pre">
			<a href="javascript:searchpage(${page.lastPage});">
				末页
